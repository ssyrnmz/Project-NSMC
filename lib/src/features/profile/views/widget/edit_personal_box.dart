...
class EditPersonalDetailsBox extends StatelessWidget {
  const EditPersonalDetailsBox({super.key});
              ...
              child: RichText(
                text: TextSpan(
                  ...
                  children: [
                    const TextSpan(
                      text:
                          'Please fill in all details accurately to ensure smooth processing of your records. ',
                    ),
                  ],
                ),
              ),
